...
All 31 features shipped. Where the implementation diverged from the original wording, the
...
| ID   | Feature                      | Acceptance criterion                                                                                                                                                                                                                                                                                                                                           | Status |
| ---- | ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| F-21 | HUD                          | Rows, not floating layers: a top strip of equal-height cards (sol counter, outside conditions, speed control, the five stocks), an alarm row under it, then left column (inspector, profiler) and right column (colony status, objectives, reserves) around the world, with the build bar at the foot                                                          | [x]    |
...
| F-31 | Inspector concept art        | Selecting a building heads its inspector with a painted full-bleed render of that building, shown uncropped at its native square aspect; all 9 kinds are covered, the Landing Pad swaps to a rocket-on-the-pad painting for as long as a rocket is parked there (test), and the images are bundled imports so the GitHub Pages base path is rewritten for them | [x]    |
...
| ID   | Feature                      | Acceptance criterion                                                                                                                                                                                                                                                                                                                                                                                                                                    | Status |
| ---- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| F-30 | Win condition and objectives | Colony wins the moment 60 sols are survived, 15 habitats stand and 150 colonists are alive, all at once (test), ending the run behind a green victory screen instead of the red loss one; a small always-on HUD panel at mid-right tracks progress toward the three thresholds and separately surfaces up to five transient prompts — feed, water, power, repair, oxygen — each shown only while its danger is live and cleared the instant it resolves | [x]    |
